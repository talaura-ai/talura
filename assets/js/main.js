...
(function ($) {
  ...
  // mobile apps review items

  var artist_galarys = document.querySelectorAll(".testimonial__item");
  var counter = 0
  ...
  let offcanvas_wrapper = document.querySelector('.offcanvas-area');
  let offcanvas_show_icon = document.querySelector('.open-offcanvas');
  let offcanvas_close_icon = document.querySelector('#close_offcanvas');
  offcanvas_show_icon.addEventListener('click', () => {
    let checkclass = offcanvas_wrapper.classList.contains('show');
    if (!checkclass) {
      offcanvas_wrapper.classList.add('show');
    } else if (checkclass) {
      offcanvas_wrapper.classList.remove('show');
    }
  })
  offcanvas_close_icon.addEventListener('click', () => {
    offcanvas_wrapper.classList.remove('show');
  })
